...
{
    kGPIO_InterruptLogic_0 = 0x0U,     /*!< Interrupt on Logic 0 (Level Low). */
    kGPIO_InterruptLogic_1 = 0x1U,     /*!< Interrupt on Logic 1 (Level High). */
    kGPIO_InterruptRisingEdge = 0x2U,  /*!< Interrupt on Rising Edge. */
    kGPIO_InterruptFallingEdge = 0x3U, /*!< Interrupt on Falling Edge. */
} gpio_interrupt_t;
...
typedef struct gpioConfigKSDK
{
    ...
    uint32_t modeFunc;              /*!< OR'ed values of type IOCON_* */
    gpio_interrupt_t interruptMode; /*!< Interrupt Mode for a pin.*/
} gpioConfigKSDK_t;
