...
#endif
#ifndef UINTPTR_MAX
// apparently this is not a constant expression: (sizeof(unsigned int *) * 256 - 1) so we have to just let this fall
// through
#endif
#endif
//-------------------------------------------------------
...
#define UNITY_OUTPUT_CHAR(a) PUTCHAR(a) // customize with debug_console in KSDK2.x
#else
...
void UnityAssertEqualStringLen(
    const char *expected, const char *actual, const _UU32 length, const char *msg, const UNITY_LINE_TYPE lineNumber);
...
#define UNITY_TEST_ASSERT_EQUAL_UINT8(expected, actual, line, message)                                           \
    UnityAssertEqualNumber((_U_SINT)(_UU8)(expected), (_U_SINT)(_UU8)(actual), (message), (UNITY_LINE_TYPE)line, \
                           UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_EQUAL_UINT16(expected, actual, line, message)                                            \
    UnityAssertEqualNumber((_U_SINT)(_UU16)(expected), (_U_SINT)(_UU16)(actual), (message), (UNITY_LINE_TYPE)line, \
                           UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_EQUAL_UINT32(expected, actual, line, message)                                            \
    UnityAssertEqualNumber((_U_SINT)(_UU32)(expected), (_U_SINT)(_UU32)(actual), (message), (UNITY_LINE_TYPE)line, \
...
#define UNITY_TEST_ASSERT_INT8_WITHIN(delta, expected, actual, line, message)                                       \
    UnityAssertNumbersWithin((_U_SINT)(_US8)(delta), (_U_SINT)(_US8)(expected), (_U_SINT)(_US8)(actual), (message), \
                             (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT8)
#define UNITY_TEST_ASSERT_INT16_WITHIN(delta, expected, actual, line, message)                                         \
    UnityAssertNumbersWithin((_U_SINT)(_US16)(delta), (_U_SINT)(_US16)(expected), (_U_SINT)(_US16)(actual), (message), \
                             (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_INT32_WITHIN(delta, expected, actual, line, message)                                         \
    UnityAssertNumbersWithin((_U_SINT)(_US32)(delta), (_U_SINT)(_US32)(expected), (_U_SINT)(_US32)(actual), (message), \
...
#define UNITY_TEST_ASSERT_EQUAL_STRING_LEN(expected, actual, len, line, message)                         \
    UnityAssertEqualStringLen((const char *)(expected), (const char *)(actual), (_UU32)(len), (message), \
                              (UNITY_LINE_TYPE)line)
#define UNITY_TEST_ASSERT_EQUAL_MEMORY(expected, actual, len, line, message)                                           \
    UnityAssertEqualMemory((UNITY_PTR_ATTRIBUTE void *)(expected), (UNITY_PTR_ATTRIBUTE void *)(actual), (_UU32)(len), \
                           1, (message), (UNITY_LINE_TYPE)line)

#define UNITY_TEST_ASSERT_EQUAL_INT_ARRAY(expected, actual, num_elements, line, message)                               \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const void *)(expected), (UNITY_PTR_ATTRIBUTE const void *)(actual), \
                             (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT)
...
#define UNITY_TEST_ASSERT_EQUAL_INT16_ARRAY(expected, actual, num_elements, line, message)                             \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const void *)(expected), (UNITY_PTR_ATTRIBUTE const void *)(actual), \
                             (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_EQUAL_INT32_ARRAY(expected, actual, num_elements, line, message)                             \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const void *)(expected), (UNITY_PTR_ATTRIBUTE const void *)(actual), \
                             (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_INT32)
#define UNITY_TEST_ASSERT_EQUAL_UINT_ARRAY(expected, actual, num_elements, line, message)                              \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const void *)(expected), (UNITY_PTR_ATTRIBUTE const void *)(actual), \
                             (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT)
...
#define UNITY_TEST_ASSERT_EQUAL_UINT32_ARRAY(expected, actual, num_elements, line, message)                            \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const void *)(expected), (UNITY_PTR_ATTRIBUTE const void *)(actual), \
                             (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_UINT32)
...
#define UNITY_TEST_ASSERT_EQUAL_HEX16_ARRAY(expected, actual, num_elements, line, message)                             \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const void *)(expected), (UNITY_PTR_ATTRIBUTE const void *)(actual), \
                             (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)line, UNITY_DISPLAY_STYLE_HEX16)
...
#define UNITY_TEST_ASSERT_EQUAL_PTR_ARRAY(expected, actual, num_elements, line, message)                         \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const void *)(_UP *)(expected), (const void *)(_UP *)(actual), \
...
#define UNITY_TEST_ASSERT_EQUAL_INT64_ARRAY(expected, actual, num_elements, line, message)                    \
    UnityAssertEqualIntArray((UNITY_PTR_ATTRIBUTE const _U_SINT *)(expected),                                 \
                             (UNITY_PTR_ATTRIBUTE const _U_SINT *)(actual), (_UU32)(num_elements), (message), \
...
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE(expected, actual, line, message)                                        \
    UNITY_TEST_ASSERT_DOUBLE_WITHIN((_UD)(expected) * (_UD)UNITY_DOUBLE_PRECISION, (_UD)expected, (_UD)actual, \
                                    (UNITY_LINE_TYPE)line, message)
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY(expected, actual, num_elements, line, message)           \
...
#define UNITY_TEST_ASSERT_DOUBLE_IS_NEG_INF(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)line, UNITY_FLOAT_IS_NEG_INF)
...
#define UNITY_TEST_ASSERT_DOUBLE_IS_NOT_INF(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)line, UNITY_FLOAT_IS_NOT_INF)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NOT_NEG_INF(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)line, UNITY_FLOAT_IS_NOT_NEG_INF)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NOT_NAN(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)line, UNITY_FLOAT_IS_NOT_NAN)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NOT_DETERMINATE(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)line, UNITY_FLOAT_IS_NOT_DET)
#endif
