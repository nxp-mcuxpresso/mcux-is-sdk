...
class ISSDK_Fxpq3115Unittest(unittest.TestCase):
    ...
    def test_unittest(self):
        ...
        self.output.testInit("ISSDK_Fxpq3115Unittest", "ISSDK Driver Examples for FXPQ3115.")
        print("\n\n****************** Executing Test  ******************\n")
        try:
            # Load the DUT image onto the DUT Board.
            testConfiguration.BOARD_OBJECT_HANDLE.loadDutImage(testConfiguration.FXPQ3115_TEST_FILE)
            time.sleep(1)
...
def suite():
    ...
    suite.addTest(unittest.makeSuite(ISSDK_Fxpq3115Unittest))
