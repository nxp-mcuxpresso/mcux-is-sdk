...
class ISSDK_Mma8491qUnittest(unittest.TestCase):
    ...
    def test_unittest(self):
        ...
        self.output.testInit("ISSDK_mma8491q_unittests", "ISSDK Driver Examples for MMA8491Q.")
        print("\n\n****************** Executing Test  ******************\n")
        try:
            # Load the DUT image onto the DUT Board.
            testConfiguration.BOARD_OBJECT_HANDLE.loadDutImage(testConfiguration.MMA8491Q_TEST_FILE)
            time.sleep(1)
...
def suite():
    ...
    suite.addTest(unittest.makeSuite(ISSDK_Mma8491qUnittest))
