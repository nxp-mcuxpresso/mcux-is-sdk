...
class ISSDK_Fxas21002Unittest(unittest.TestCase):
    ...
    def test_unittest(self):
        ...
        self.output.testInit("ISSDK_fxas21002_unittests", "ISSDK Driver Examples for FXAS21002.")
        print("\n\n****************** Executing Test  ******************\n")
        try:
            # Load the DUT image onto the DUT Board.
            testConfiguration.BOARD_OBJECT_HANDLE.loadDutImage((testConfiguration.FXAS21002_TEST_FILE).replace("AGM01", FXAS21002_SHIELD_NAME))
            time.sleep(1)
...
def suite(shield_name = "AGM01"):
    ...
    suite.addTest(unittest.makeSuite(ISSDK_Fxas21002Unittest))
