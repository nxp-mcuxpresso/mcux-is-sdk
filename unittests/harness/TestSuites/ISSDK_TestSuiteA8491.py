...
output.suiteInit("ISSDK Unittests for A8491 Sensor Board", "Test ISSDK Drivers")

import unittest
import xmlrunner
import ISSDK_Mma8491qUnittest

ISSDKTestSuite = unittest.TestSuite()
ISSDKTestSuite.addTest(ISSDK_Mma8491qUnittest.suite())
