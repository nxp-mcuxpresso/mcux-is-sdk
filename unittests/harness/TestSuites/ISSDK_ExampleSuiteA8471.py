...
output.suiteInit("ISSDK Driver Examples for A8471 Sensor Board", "Test ISSDK Drivers")
...
ISSDKTestSuite.addTest(ISSDK_Fxls8471qExamples.suite())
ISSDKTestSuite.addTest(ISSDK_Host_Demo.suite(shield_name = "A8471", ads_shield = "A8471"))
