'''
@author    : B35385
@name      : ISSDK_ExampleSuiteOnBoardKL27Z
...
output.suiteInit("ISSDK Driver Examples for OnBoard KL27Z Sensor MMA8451 and MAG3110", "Test ISSDK Drivers")

import unittest
import xmlrunner
import ISSDK_Host_Demo
import ISSDK_Mma845xExamples
import ISSDK_Mag3110KL27Examples

ISSDKTestSuite = unittest.TestSuite()
ISSDKTestSuite.addTest(ISSDK_Mma845xExamples.suite())
ISSDKTestSuite.addTest(ISSDK_Mag3110KL27Examples.suite())
...
if testConfiguration.BOARD_NAME != "KL27Z":
    print("This suite runs only on FRDM-KL27Z %s" % testConfiguration.BOARD_NAME)
    sys.exit()
