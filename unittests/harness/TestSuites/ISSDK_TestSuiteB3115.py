...
output.suiteInit("ISSDK Unittests for B3115 Sensor Board", "Test ISSDK Drivers")

import unittest
import xmlrunner
import ISSDK_Fxpq3115Unittest

ISSDKTestSuite = unittest.TestSuite()
ISSDKTestSuite.addTest(ISSDK_Fxpq3115Unittest.suite())
