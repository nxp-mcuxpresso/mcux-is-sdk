'''
@author    : B35385
@name      : ISSDK_TestSuiteSimulator
@copyright : Copyright (c) 2016, NXP Semiconductors.

********************************************************************************
This is an automated test suite designed to run the ISSDK Unit-Test Cases.
********************************************************************************
'''
...
import unittest
import xmlrunner
import ISSDK_Mpl3115SimTests
import ISSDK_Fxas21002SimTests
import ISSDK_Fxos8700SimTests


ISSDKTestSuite = unittest.TestSuite()
ISSDKTestSuite.addTest(ISSDK_Fxas21002SimTests.suite())
ISSDKTestSuite.addTest(ISSDK_Fxos8700SimTests.suite())
ISSDKTestSuite.addTest(ISSDK_Mpl3115SimTests.suite())
