...
void BleApp_Init(void)
{
    ...
    /* Default Reporting Mode is Altimeter. */
    gReportMode = ISSDK_REPORT_ALTITUDE;
    BleApp_WriteToUART("\r\n Default Report Mode is Altimeter.\r\n");
}
...
static void BleApp_ConnectionCallback (deviceId_t peerDeviceId, gapConnectionEvent_t* pConnectionEvent)
{
    switch (pConnectionEvent->eventType)
    {
        case gConnEvtConnected_c:
        {
            ...
            ISSDK_ConfigureSensor(ISSDK_SENSOR_START);
...
//                    Gap_Pair(peerDeviceId, &gPairingParameters);
        ...
        case gConnEvtDisconnected_c:
        {
            ...
            ISSDK_ConfigureSensor(ISSDK_SENSOR_STOP);
...
static void BleApp_ReceivedUartStream(uint8_t *pStream, uint16_t streamLength)
{
    ...
    if (0 == strncasecmp(pStream, ISSDK_REPORT_ALTITUDE_STR, strlen(ISSDK_REPORT_ALTITUDE_STR)))
    {
        gReportMode = ISSDK_REPORT_ALTITUDE;
        BleApp_WriteToUART("\r\n Switching To Altimeter Mode.\r\n");

        /* Change Sensor Configuration to Altimeter Mode */
        ISSDK_ConfigureSensor(ISSDK_SENSOR_STOP);
        ISSDK_ConfigureSensor(ISSDK_SENSOR_ALTITUDE_MODE);
        ISSDK_ConfigureSensor(ISSDK_SENSOR_START);
    }
    else if (0 == strncasecmp(pStream, ISSDK_REPORT_PRESSURE_STR, strlen(ISSDK_REPORT_PRESSURE_STR)))
    {
        gReportMode = ISSDK_REPORT_PRESSURE;
        BleApp_WriteToUART("\r\n Switching To Barometer Mode.\r\n");

        /* Change Sensor Configuration to Barometer Mode */
        ISSDK_ConfigureSensor(ISSDK_SENSOR_STOP);
        ISSDK_ConfigureSensor(ISSDK_SENSOR_PRESSURE_MODE);
        ISSDK_ConfigureSensor(ISSDK_SENSOR_START);
    }
