...
* ile
*
* This file is the source file for the Thermometer application with MPL3115.
* All rights reserved.
*
...
static void TimerMeasurementCallback(void * pParam)
{
    ...
    ISSDK_ReadSensor(&tempInDegrees);

    tempMeas.tempTypePresent = TRUE;
    tempMeas.tempType = gHts_Finger_c;
    ...
    tempMeas.temperature = tempInDegrees;
