...
int8_t FXAS21002_Read(struct PhysicalSensor *sensor, Globals *gbls)
{
    ...
    if (gbls->Gyro.iWhoAmI == FXAS21002_WHO_AM_I_WHOAMI_OLD_VALUE)
    {
        ...
        for (j = 0; j < sensor_fifo_count; j++)
        {
            ...
            if (status==SENSOR_ERROR_NONE) {
                ...
                addToFifo((union FifoSensor*) &(gbls->Gyro), GYRO_FIFO_SIZE, sample);
            }
        }
