...
int8_t MAG3110_Init(struct PhysicalSensor *sensor, Globals *gbls)
{
    ...
    gbls->Mag.iCountsPerFloat = MAG3110_COUNTSPERUT;
    gbls->Mag.fCountsPerFloat = (float)MAG3110_COUNTSPERUT; // IAR optimized this out without the #pragma before the function
    gbls->Mag.fFloatPerCount = 1.0F / MAG3110_COUNTSPERUT;  // IAR optimized this out without the #pragma before the function

    sensor->isInitialized = F_USING_MAG;        // IAR optimized this out without the #pragma before the function
    gbls->Mag.isEnabled = true;                  // IAR optimized this out without the #pragma before the function
