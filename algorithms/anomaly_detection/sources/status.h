...
typedef struct StatusSubsystem {
	...
	ad_status_t		previous;       ///< Previous status state - ad_status_t is defined in anomaly_detection.h
	ad_status_t		status;         ///< Current status
	ad_status_t		next;           ///< Pending status change
	// Required methods
