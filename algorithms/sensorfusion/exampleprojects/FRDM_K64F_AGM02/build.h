...
#define MAG_FIFO_SIZE 		32	///< FXOS8700 (mag), MAG3110 have no FIFO so equivalent to 1 element FIFO
#define GYRO_FIFO_SIZE 		32	///< FXAX21000, FXAS21002 have 32 element FIFO
#define ACCEL_ODR_HZ 		400    	///< (int) requested accelerometer ODR Hz (over-rides MAG_ODR_HZ for FXOS8700)
#define MAG_ODR_HZ 		80    	///< (int) requested magnetometer ODR Hz
...
#define OVERSAMPLE_RATE         FAST_LOOP_HZ/FUSION_HZ // MUST BE AN INTEGER
///@}
