...
IarBuild.exe  FRDM_K22F_AGM03_FreeRTOSTwoTasks/main.ewp -clean Debug
IarBuild.exe  FRDM_K22F_MULT2B_FreeRTOSTwoTasks/main.ewp -clean Debug
IarBuild.exe  FRDM_K64F_AGM01_BARE_METAL/main.ewp -clean Debug
IarBuild.exe  FRDM_K64F_AGM01_FreeRTOSTwoTasks/main.ewp -clean Debug
IarBuild.exe  FRDM_K64F_AGM01_FreeRTOSTwoTasksPowerCycling/main.ewp -clean Debug
...
IarBuild.exe  FRDM_KL25Z_BARE_METAL/main.ewp -clean Debug
IarBuild.exe  FRDM_KL25Z_FreeRTOSTwoTasks/main.ewp -clean Debug
IarBuild.exe  LPC54114_AGM01_FreeRTOSTwoTasks/iar/cm4\main.ewp -clean Debug
