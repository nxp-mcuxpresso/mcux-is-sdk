...
/*
============================================================================
 Name        : KeynetikRunningStats.h
 Author      : KEYnetik, Inc.
 Version     :
 Copyright   : Copyright 2010 by KEYnetik, Inc.
 Description : Pedometry interface for Eve Pedometer project, step counter, statistics and running statistics package
============================================================================
*/
...
/*
* Pedometry statistcics (since last KeynetikInitialize), populated by the latest call to KeynetikHandleIncomingEvent:
*/
/*
* Step count
*/
...
/*
* Running statistcics (since last KeynetikResetRunningStats), populated by the latest call to
* KeynetikHandleIncomingEvent:
*/
/*
* Running step count
*/
extern unsigned int keynetikRunningStepCount;
/*
* Running distance covered (in meters)
*/
extern unsigned int keynetikRunningDistance;
/*
* Running average speed (in meters per hour).
*/
extern unsigned int keynetikRunningSpeed;
/*
* Running calories buirned (since last KeynetikInitialize), populated by the latest call to KeynetikHandleIncomingEvent.
*/
extern unsigned int keynetikRunningCalories;
...
/**
* Initialize a new set of running statistics. All running statistics variables are set to 0.
*/
void KeynetikResetRunningStats(void);
