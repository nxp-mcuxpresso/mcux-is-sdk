...
/**
 * @file evkcmimxrt1060.c
 * @brief The evkcmimxrt1060.c file defines GPIO pins and I2C CMSIS utilities for
 * evkcmimxrt1060 board.
 */

#include "evkcmimxrt1060.h"
...
// EVKCMIMXRT1060 Arduino Connector Pin Defintion
