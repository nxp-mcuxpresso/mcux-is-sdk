...
hci_look_for_cmd_desc = 0x030119cd;
...
llc_hci_acl_data_tx_handler = 0x030179fd;
llc_hci_command_handler = 0x03017a95;
llc_le_con_cmp_evt_send = 0x03017b39;
...
llc_util_get_free_conhdl = 0x03019625;
...
lld_pdu_llcp_pk_desc_tab = 0x0302b950;
...
llm_enc_ind_handler = 0x0302134d;
llm_end_evt_defer = 0x030215c5;
...
llm_ral_set_timeout = 0x03022009;
